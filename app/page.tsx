  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-full relative z-40 overflow-hidden px-10">
      ...
      <div className="flex flex-col items-center justify-center text-center max-w-2xl">
        ...
        >
          <h1 className={`text-6xl md:text-9xl font-display font-bold text-transparent bg-clip-text bg-gradient-to-b from-white to-zinc-500 animate-title tracking-tighter text-glow drop-shadow-[0_0_30px_rgba(255,255,255,0.3)] ${colors.text}`}>
            DmanDev
          </h1>
        </motion.div>

        <div className={`w-48 h-px bg-gradient-to-r from-transparent via-${colors.primary}-500/50 to-transparent my-8`} />
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Link
              href="/projects"
              className={`group relative px-8 py-3 bg-zinc-950 border ${colors.border} ${colors.text} font-mono text-[10px] tracking-[0.3em] uppercase hover:bg-zinc-900 hover:text-white hover:shadow-[0_0_20px_rgba(0,0,0,0.5)] transition-all duration-500`}
            >
              <div className={`absolute inset-0 bg-${colors.primary}-400/10 opacity-0 group-hover:opacity-100 transition-opacity`} />
              Initialize Projects
            </Link>
